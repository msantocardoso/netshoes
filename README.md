...
Ao digitar o endereço do site da Netshoes o navegador fará uma requisição HTTP para o servidor, no cabeçalho da solicitação será adicionado diversas informações como identificação do solicitante "User-Agent: Mozilla/5.0 (X11; U; Linux i686; en-US)...", método HTTP (GET/ seguido da versão do protocolo "HTTP/1.1"), tipo de dado esperado "Accept: text/xml,application/xml,application/xhtml", dentre outros... O servidor recebará a solicitação, realiza o processamento e devolve o resultado para o solicitante. Ao receber a resposta o navegador iniciará solicitação, carregamento dos recursos estáticos e processamento da página. Para cada recurso estático o dispositivo fará uma nova solicitação ao servidor que entregará o recurso, o navegador irá processá-lo e ao finalizar disponibilizará a página ao usuário.
